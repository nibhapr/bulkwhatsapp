...
<div class="file-uploader">
    <label class="form-label mt-4">Media Url *Select from file manager,or fill manual</label><span class="text-danger text-sm">make sure the URL goes directly to the media.</span>
